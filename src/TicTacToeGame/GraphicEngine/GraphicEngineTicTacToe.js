...
class GraphicEngineTicTacToe {
    ...
    createBoard() {
        ...
        this.createCircleAtPosition('initialBase0', 4);
        this.createCircleAtPosition('initialBase0', 5);
        //Cross
        ...
        this.createCrossAtPosition('initialBaseX', 4);
        this.createCrossAtPosition('initialBaseX', 5);
    }
